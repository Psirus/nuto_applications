...
void SetCommonBCs(Structure& structure, Group<NodeBase>& nodesTop, Group<NodeBase>& nodesBottom, NodeBase& primary,
                  std::function<double(double)> temperatureRamp, double radius)
{
...
int main(int argc, char* argv[])
{
    ...
    const double height = std::stod(argv[5]);
    ...
    SetCommonBCs(structure, nodesTop, nodesBottom, primary, temperatureRamp, radius);
